				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
				  ...
				  ?>
					<li class="nav-item dropdown lang">
					  <a class="nav-link dropdown-toggle cambio_idioma" href="" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img class="menu-flag" src='../assets/img/flags/es.png'>ES</a>
					  <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
					  		<li><a class="dropdown-item cambio_idioma" href="../"><img class="menu-flag" src='../assets/img/flags/gb.png'>EN</a></li>
							...
							<li><a class="dropdown-item cambio_idioma" href="../fr/"><img class="menu-flag" src='../assets/img/flags/fr.png'>FR</a></li>

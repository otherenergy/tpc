...
$obten_estados_us = $checkout->obten_estados_us($id_idioma);
		...
		<div class="row">
			...
			<script>
				document.addEventListener('DOMContentLoaded', function() {
					const countrySelect = document.getElementById('input_pais');
					const provSelect = document.getElementById('input_prov');
					const labelProv = document.getElementById('label_prov');
					const estadosUS = <?php echo json_encode($obten_estados_us); ?>;

					countrySelect.addEventListener('change', function() {
						const selectedCountry = this.value;

						if (selectedCountry === 'US') {
							labelProv.innerHTML = 'Estados <span style="color:red;">*</span>';
							provSelect.innerHTML = '<option value="-">- Select state -</option>';

							estadosUS.forEach(state => {
								const option = document.createElement('option');
								option.value = state.cod;
								option.text = state.nombre;
								provSelect.appendChild(option);
							});

							provSelect.innerHTML += '<option value="xxx">- Other state -</option>';
							provSelect.disabled = false;
						} else {
							labelProv.innerHTML = '<?php echo $vocabulario_provincia; ?> <span style="color:red;">*</span>';

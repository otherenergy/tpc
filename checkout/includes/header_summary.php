					...
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="row punto-pedido">
								...
								<div class="col-md-1 lin-proc"><div class="ln"></div></div>
								<div class="col-md-2"><div class="linea-punto pag"><div class="circulo rell" onclick="window.location.href='mode-paiement'"><span class="num"><i class="ok fas fa-check"></i></span></div><p>Méthode de paiement</p></div></div>
								<div class="col-md-1 lin-proc"><div class="ln"></div></div>
								<div class="col-md-2"><div class="linea-punto conf"><div class="circulo"><span class="num">4</span></div><p>Résumé</p></div></div>
							</div>
						</div>
						<div class="col-sm-2">
							<div class="row">

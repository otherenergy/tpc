...
from generar_schemas import generar_schemas
...
#   consulta_urls_cursor="SELECT urls.id_url, urls.id_tipo, urls.id_idioma, urls.valor, productos.id AS id_producto FROM urls LEFT JOIN productos ON urls.id_url = productos.id_url WHERE urls.id_idioma=%s;"

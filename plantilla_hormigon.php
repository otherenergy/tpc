...
<html lang="<?php echo (strpos($idioma_url, '-') === false) ? $idioma_url . '-' . strtoupper($idioma_url) : strtolower(explode('-', $idioma_url)[0]) . '-' . strtoupper(explode('-', $idioma_url)[1]); ?>">
    ...
    <link rel="stylesheet" href="../assets/css/hormigon.css?<?php echo rand() ?>">
    <link rel="preload" href='../assets/css/hormigon.css?<?php echo rand() ?>' as="style" />

    <body class="hormigon_impreso">
        <?php include('../includes/header.php'); ?>

        <div class="contenedor_inicial_hormigon">
            <div class="contenedor_texto_inicial_hormigon">
                <?php echo $contenido[1][1]; ?>
            </div>
            <div class="contenedor_imagen_inicial_hormigon">
                <img src="../assets/img/hormigon-impreso/Smart_Cover_Repair_web_personaje_main.webp" alt="">
            </div>
        </div>  
        <div class="contenedor_imagen_fondo_hormigon">
            <img src="../assets/img/hormigon-impreso/fondo_impreso_wide.webp" alt="">
        </div>

        <div class="contenedor_video_hormigon">
            <div class="contenedor_video_hormigon_content">
                <?php echo $contenido[2][1]; ?>

                <!-- COMPROBAR, PORQUE NO APARECE EN EL EXCEL EL BOTÓN -->
                <!-- <a href="#">Quiero mantener el hormigón impreso</a> -->
            </div>
            <div class="contenedor_video_hormigon_iframe">
                <img class="img_tv" src="../assets/img/hormigon-impreso/television_impreso.webp" alt="TV">
                <?php echo $contenido[2][2]; ?>
            </div>
        </div>

        <div class="contenedor_ventajas_hormigon">
            <?php echo $contenido[3][1]; ?>
            <div class="contenedor_ventaja"></div>
        </div>

        <div class="contenedor_inicial_paso_paso_hormigon">
            <div class="contenedor_inicial_paso_paso_hormigon_txt">
                <?php echo $contenido[4][1]; ?>
            </div>        
            <div class="contenedor_botones_mostar_paso_paso">
                <div id="mostrar_paso_paso_1">
                    <img src="../assets/img/hormigon-impreso/Impreso_web_smartcret-paso-paso.webp" alt="Paso a paso baños, duchas y cocinas">
                </div>
                <div id="mostrar_paso_paso_2">
                    <img src="../assets/img/hormigon-impreso/Smart_Cover_Repair_Web_Paso.webp" alt="Paso a paso paredes">
                </div>
            </div>
        </div>

        <div class="contenedor_reparar_grietas_hormigon">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const sinJuntasElement = document.getElementById('paso_paso_hormigon_1');
                const conJuntasElement = document.getElementById('paso_paso_microcemento_2');
                const sinJuntasH3 =  document.getElementById('h3_paso_paso_hormigon_1')
                const conJuntasH3 =  document.getElementById('h3_paso_paso_hormigon_2')
        ...
        <!-- <h3 class="h3_paso_paso_microcemento" id="h3_paso_paso_microcemento_1">PASO A PASO BAÑOS, DUCHAS Y COCINAS</h3>
        <h3 class="h3_paso_paso_microcemento ocultar" id="h3_paso_paso_microcemento_2">PASO A PASO PAREDES</h3> -->
        
        <div class="acordeon" id="paso_paso_hormigon_1">
            <?php echo $contenido[6][1]; ?>
        </div>

        <div class="contenedor-ventajas-smart-cover-repair">
        ...
        <!-- HASTA AQUI TEXTO INTRODUCIDO -->

        <div class="acordeon" id="paso_paso_hormigon_2">
        ...
        <div class="contenedor_colores_hormigon">
            <div class="contenedor_primero_colores_hormigon">
                <?php echo $contenido[12][1]; ?>         
            </div>
            <div class="contenedor_segundo_colores_microcemento">
                <?php echo $contenido[12][2]; ?>                
                <div class="contenedores_listado_colores">

                    <div class="gama_a">
                        <div class="contenedor_txt_gamma_colores">
                            <?php echo $contenido[12][3]; ?>     
                            <div class="contenedor_gammas_colores">
                                <?php
                                    $colores = $userClass->obtener_gammas_colores(15, $id_idioma);
                            ...
                            <?php
                                ...
                                foreach ($colores as $color) {
                                    ...
                                    <div class="contenedor_imagen_color_gammas<?php echo $claseDivAdicional; ?>" data-color="<?php echo $color->valor; ?>">
                                        <img class="imagen_color_gammas<?php echo $claseImagenAdicional; ?>" src-zoom="../assets/img/colores/smartcover-repair/<?php echo $color->valor; ?>.webp" src="../assets/img/colores/smartcover-repair/<?php echo $color->valor; ?>.webp" alt="<?php echo $vocabulario_ellegance_colletion ?> <?php echo $color->valor; ?>" title="<?php echo $vocabulario_ellegance_colletion ?> <?php echo $color->valor; ?>">
                    ...
                    <div class="gama_b" style="display:none;">
                        <div class="contenedor_txt_gamma_colores">
                            <?php echo $contenido[12][4]; ?>     

                            <div class="contenedor_gammas_colores">
                                <?php
                                    $colores = $userClass->obtener_gammas_colores(16, $id_idioma);
                                    foreach ($colores as $color) { ?>
                                <button class="btn_color" data-color="<?php echo $color->valor; ?>">
                                    <?php echo $color->valor; ?>
                                </button>
                    ...
                    <div class="gama_c" style="display:none;">
                        <div class="contenedor_txt_gamma_colores">
                            ...
                            <?php echo $contenido[12][5]; ?>   
                            <div class="contenedor_gammas_colores">
                                <?php
                                    $colores = $userClass->obtener_gammas_colores(17, $id_idioma);
                                    foreach ($colores as $color) { ?>
                                <button class="btn_color" data-color="<?php echo $color->valor; ?>">
                                    <?php echo $color->valor; ?>
                                </button>
                    ...
                    <div class="gama_d" style="display:none;">
                        <div class="contenedor_txt_gamma_colores">
                            <?php echo $contenido[12][6]; ?>   
                            <div class="contenedor_gammas_colores">
                                <?php
                                    $colores = $userClass->obtener_gammas_colores(18, $id_idioma);
                                    foreach ($colores as $color) { ?>
                                <button class="btn_color" data-color="<?php echo $color->valor; ?>">
                                    <?php echo $color->valor; ?>
                                </button>
                    ...
                    <div class="gama_e" style="display:none;">
                        <div class="contenedor_txt_gamma_colores">
                            <?php echo $contenido[12][7]; ?>   
                            <div class="contenedor_gammas_colores">
                                <?php
                                    $colores = $userClass->obtener_gammas_colores(19, $id_idioma);
                                    foreach ($colores as $color) { ?>
                                <button class="btn_color" data-color="<?php echo $color->valor; ?>">
                                    <?php echo $color->valor; ?>
                                </button>
                    ...
                    <div class="gama_f" style="display:none;">
                        <div class="contenedor_txt_gamma_colores">
                            <?php echo $contenido[12][8]; ?>   
                            <div class="contenedor_gammas_colores">
                                <?php
                                    $colores = $userClass->obtener_gammas_colores(20, $id_idioma);
                                    foreach ($colores as $color) { ?>
                                <button class="btn_color" data-color="<?php echo $color->valor; ?>">
                                    <?php echo $color->valor; ?>
                                </button>
    ...
    if (window.innerWidth > 992) {
        if (containerElement) {
            ...
            elements_anterior_paso_paso_2.forEach((elemento, index) => {
                var currentWidth = containerWidth - numero_big - (index * 100);
                elemento.style.right = `${currentWidth}px`;
                elemento.style.left = 'auto';
                elemento.style.transition = '1s';
            });
            ...
            for (let index = elements_posterior_paso_paso_2.length - 1; index >= 0; index--) {
                ...
                var currentWidth = numero_big + ((elements_posterior_paso_paso_2.length - 1 - index) * 100);
                elemento.style.right = `${currentWidth}px`;
                elemento.style.left = 'auto';
                elemento.style.transition = '1s';
            }

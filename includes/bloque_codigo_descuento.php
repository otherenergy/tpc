...
if ( $_SESSION['codigo_descuento']['p2x1'] != 0 ) {
	...
	<td class="der importe_descuento">
		<span>- <?php echo $descuento_kits ?> €</span>
	</td>
</tr>
...
<tr>
	<td align="center" colspan="2"><button type="button" id="elimina_descuento" class="cart_btn out" onclick='eliminaCupon()' style="font-size: 12px;padding: 2px 7px;"><?php echo trad('Eliminar descuento') ?></button></td>
</tr>
					...
					<a class="enlace-logo-smartcret" href="<?php echo $ruta_link2 ?>">
						<nav class='contenedor-logo-smartcret'>
							<nav class='contenedor-moverse-logo-smartcret'>
								...
								<img class="img-logo-smartcret-big" src="<?php echo $ruta_link1 ?>assets/img/logo-smartcret.webp" alt="Smartcret" title="Smartcret" width="171.5px" height="95px">
							</nav>
						</nav>
					  ...
					  <ul class="menu_accesible">
							...
							<li class="menu_oferta">
								<a class="" style="color: #c93285;" href="<?php echo $ruta_link2 ?><?php echo $link_ofertas_smartcret ?>"><?php echo $vocabulario_ofertas ?>
									<img alt="icono descuento web" src="<?php echo $ruta_link1 ?>assets/img/iconos/DESCUENTO_WEB.png" alt="<?php echo $vocabulario_ofertas_smartcret ?>" width="20px" height="20px" />
								</a>
							</li>
							<?php

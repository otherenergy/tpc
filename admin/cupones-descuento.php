				...
				<div class="row">
					...
					<div class="col-md-4" style="text-align: right;">
						<button class="enlace_descuento_distribuidor" >
							<a href="./cupones-descuento-dis?activo=0">Descuentos de distribuidores</a>	
						</button>
				...
				<div class=" table-responsive">
					<table id="tbl_pedidos" class="table carrito dir_fac">
						...
						<tbody>
							<?php
							if ($activo == 0) {
								$sql = "SELECT * FROM cupones_descuento WHERE eliminado= 0 AND distribuidor IS NULL ORDER BY fecha_creacion DESC";
							} else {
								$sql = "SELECT * FROM cupones_descuento WHERE activo=1 AND eliminado=0 AND distribuidor IS NULL ORDER BY fecha_creacion DESC";
							}

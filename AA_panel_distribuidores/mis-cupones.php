            ...
            <div class="col-md-2 menu-lat">
                <div class="menu-panel">
                    <table>
                        ...
                        <tr class="link">
                            <td>
                                <div class="item current"><a class="nav-link" href="<?php echo $ruta_link2 ?>panel/documentacion"><i class="fas fa-tags"></i>Mis cupones</a></div>
                            </td>
                        </tr>
                        <tr class="link">
                            <td>
                        ...
                        <tr class="link">
                            <td>
                                <div class="item"><a class="nav-link" href="<?php echo $ruta_link2 ?>panel/documentacion"><i class="fas fa-envelope"></i>Contacto</a></div>
                            </td>
                        </tr>
                        <tr class="link">
                            <td>
                ...
                <div class="div-cupones-descuentos">
                    ...
                    <div class="cupon-container">
                        <div class="cupon-header">
                            <p id="cupon-1">99348h9</p>
                            <button onclick="copiarTexto('cupon-1')">
                                <i class="fas fa-copy"></i> Copiar
                            </button>
                        </div>
                        <p class="cupon-description">Este cupón ofrece un descuento del 10% en todas las compras de productos seleccionados. Úsalo antes del 31 de diciembre.</p>
                    </div>
                    <div class="cupon-container">
                        <div class="cupon-header">

            ...
            <div class="col-md-2 menu-lat">
                <div class="menu-panel">
                    <table>
                        ...
                        <tr class="link">
                            <td>
                                <div class="item"><a class="nav-link" href="<?php echo $ruta_link2 ?>panel/documentacion"><i class="fas fa-tags"></i>Mis cupones</a></div>
                            </td>
                        </tr>
                        <tr class="link">
                            <td>
                                    ...
                                    <tr class="datos pedidos">
                                        ...
                                        <?php } else { ?>
                                            <td class="der">
                                                ...
                                                <!-- <a class="estado" href="../../admin/facturas/facturas_usuario/descargarFactura.php?ref=<?php echo urlencode($reg->ref_pedido); ?>" style="cursor: pointer;"> -->

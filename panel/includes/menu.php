...
<li class="nav-item">
	<a class="nav-link active" href="../tienda-microcemento">Tienda</a>
</li>
<li class="nav-item">
...
<li class="nav-item carrito">
	<a class="nav-link" href="javascript:$('#lista-productos').fadeIn(100);$('.navbar-collapse').addClass('show');" alt="Carrito" title="Carrito" rel="nofollow"><img src="../assets/img/iconos/carrito.png" alt="Carrito" title="Carrito" style="width: 25px;"><span id="numprod" class="circ"><?php echo $carrito->articulos_total() ?></span></a>
	<!-- <a class="nav-link" href="javascript:$('#lista-productos').fadeIn(200);$('.navbar-toggler-icon').click()" alt="Carrito" title="Carrito" rel="nofollow"><img src="../assets/img/iconos/carrito.png" alt="Carrito" title="Carrito" style="width: 25px;"><span id="numprod" class="circ"><?php echo $carrito->articulos_total() ?></span></a> -->
</li>
			...
			foreach($carro as $producto) { ?>
				...
				<tr class="datos">
					...
					<td>
						...
						<i class="fa fa-times transform" onclick="eliminaArticulo('<?php echo $producto["unique_id"] ?>');actualizaCarrito()"></i>
					</td>
				</tr>
